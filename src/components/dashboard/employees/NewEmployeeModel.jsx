    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="emp-name" className="block text-sm font-medium text-gray-700 mb-1">
              Full Name *
            </label>
            <input
              id="emp-name"
          ...
          <div>
            <label htmlFor="emp-role" className="block text-sm font-medium text-gray-700 mb-1">
              Role *
            </label>
            <select
              id="emp-role"
          ...
          <div>
            <label htmlFor="emp-email" className="block text-sm font-medium text-gray-700 mb-1">
              Email *
            </label>
            <input
              id="emp-email"
          ...
          <div>
            <label htmlFor="emp-phone" className="block text-sm font-medium text-gray-700 mb-1">
              Phone *
            </label>
            <input
              id="emp-phone"
