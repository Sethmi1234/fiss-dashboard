    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="pl-customer" className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div>
            <label htmlFor="pl-phone" className="block text-sm font-medium text-gray-700 mb-1">
              Phone *
            </label>
            <input
              id="pl-phone"
          ...
          <div>
            <label htmlFor="pl-principal" className="block text-sm font-medium text-gray-700 mb-1">
              Principal Amount (Rs.) *
            </label>
            <input
              id="pl-principal"
          ...
          <div>
            <label htmlFor="pl-interest" className="block text-sm font-medium text-gray-700 mb-1">
              Interest Rate (%) *
            </label>
            <input
              id="pl-interest"
          ...
          <div>
            <label htmlFor="pl-installments" className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div>
            <label htmlFor="pl-startdate" className="block text-sm font-medium text-gray-700 mb-1">
              Start Date *
            </label>
            <input
              id="pl-startdate"
          ...
          <div>
            <label htmlFor="pl-collateral" className="block text-sm font-medium text-gray-700 mb-1">
              Collateral / Security
            </label>
            <textarea
              id="pl-collateral"
              name="collateral"
              placeholder="e.g. Property deed, vehicle, etc."
              value={form.collateral}
              onChange={handleChange}
              rows={3}
              className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-purple-400 resize-none"
            />
          </div>
