  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-3 sm:p-6">
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col lg:flex-row w-full max-w-6xl">
        ...
        {/* Left image panel */}
        <motion.div
          className="relative h-56 sm:h-72 lg:h-auto lg:w-1/2 lg:min-h-[640px]"
        ...
        >
          ...
          <motion.div
            className="relative z-10 flex h-full items-end lg:items-center justify-start p-6 sm:p-8 lg:p-10 text-white"
          ...
          >
            <div className="max-w-sm">
              ...
              <p className="text-sm sm:text-base opacity-90 mb-4 sm:mb-6">
                Manage loans, customers and transactions with confidence.
                Welcome to FINEXA dashboard.
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="max-w-md mx-auto w-full">
            ...
            <p className="text-sm sm:text-base text-gray-500 mb-6">
              Sign in to your account to continue to FINEXA
            </p>

            <LoginForm />

            <div className="mt-4 text-center">
              <button className="text-sm text-gray-500 underline hover:text-gray-700 transition">
                Continue with OTP code
              </button>
            </div>
